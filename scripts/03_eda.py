...
Performs comprehensive exploratory data analysis on cleaned wine quality dataset,
generating visualizations for quality distributions, feature correlations, and
correlation heatmaps.

This script:
- Loads cleaned wine data from CSV
- Creates quality distribution plots (overall, by type, and categories)
- Analyzes feature correlations with wine quality
- Generates a correlation heatmap for all physicochemical features
...
Output:
    ...
    - feature_correlations.png: Bar chart of feature correlations with quality
    - correlation_heatmap.png: Heatmap showing feature intercorrelations
"""
...
def create_quality_distributions(wine_data, output_dir):
    ...
    category_counts.plot(kind='pie', ax=axes[2], autopct='%1.1f%%', 
...
def create_feature_correlations(wine_data, output_dir):
...
def create_correlation_heatmap(wine_data, feature_cols, output_dir):
